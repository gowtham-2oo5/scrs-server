...
export default function OTPModal({ message, isOpen, onClose }) {
    ...
    return (
        <Dialog className="z-50" open={isOpen} onOpenChange={() => onClose()}>
            <DialogContent className="sm:max-w-[425px] bg-blue-100" aria-describedby={undefined}>
                <DialogHeader>
                    <DialogTitle className="text-center text-blue-600">Verify Your Email</DialogTitle>
                </DialogHeader>
                <div className="flex flex-col items-center space-y-4">
                    <Label htmlFor="otp-input" className="text-center text-blue-800">{message}</Label>
                    <InputOTP
                        maxLength={6}
